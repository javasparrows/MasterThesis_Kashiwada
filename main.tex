...
\setlength{\topmargin}{-0.4truemm}      % 上の余白を20mm(=1inch-5.4mm)に
...
\renewcommand\arraystretch{1.1} %% ちょっとkansoku

\input{chapters/表紙} %「表紙.tex」というファイルを同じディレクトリ上においておくこと。
%
\frontmatter
...
\input{chapters/研究背景.tex}
\input{chapters/基礎理論.tex}
\input{chapters/解析方法.tex}
\input{chapters/模擬データによる定量評価.tex}
\input{chapters/観測データ解析.tex}
\input{chapters/まとめと議論.tex}
